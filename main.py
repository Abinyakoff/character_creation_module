...
def attack(char_name: str, char_class: str) -> str:
    """The function returns the damage value."""
...
def defence(char_name: str, char_class: str) -> str:
    """The function returns the value of the block."""
    if char_class == 'warrior':
    ...
    return ('урон не блокирован, соперник был ловчее')


def special(char_name: str, char_class: str) -> str:
    """The function returns the attack value."""
    if char_class == 'warrior':
    ...
    return ('ваша сила закончилась')


def start_training(char_name: str, char_class: str) -> str:
    """The function returns the value of the character."""
    if char_class == 'warrior':
